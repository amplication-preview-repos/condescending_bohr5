...
import { FlowFindManyArgs } from "../../flow/base/FlowFindManyArgs";
...
export class BotControllerBase {
  ...
  async findFlows(
    ...
    const query = plainToClass(FlowFindManyArgs, request.query);
    const results = await this.service.findFlows(params.id, {
      ...query,
      select: {
        bot: {
          select: {
  ...
  @common.Post("/:id/flows")
  async connectFlows(
    @common.Param() params: BotWhereUniqueInput,
    @common.Body() body: FlowWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      flows: {
        connect: body,
  ...
  @common.Delete("/:id/flows")
  async disconnectFlows(
    @common.Param() params: BotWhereUniqueInput,
    @common.Body() body: FlowWhereUniqueInput[]
  ): Promise<void> {
    const data = {
